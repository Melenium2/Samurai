...
// - Отдавать даты с одинаковым форматирвоанием чтобы не было проблем с аналитикой
//		--- Переделать форматирование даты приходящие с gp
//			appstore имеет формат 2020-12-25
