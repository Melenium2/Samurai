...
// --- Надо другим способом передовать категории в executor
//		Думаю надо создать какой то файлик и там отдавать в зависимости
//		от того какое приложение будет трекатсья
//		(Доделать тест, сейчас пассает все кроме категорий)
// --- Сделать экспоненциальное повторение для каждого из методов
// - Переписать конфиг в мейн
